...
<div id="page-wrapper">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table width="100%"
                        ...
                        <tbody>
                        <c:forEach items="${customer}" var="item" varStatus="i">
                            <tr class="odd gradeX">
                                <td>${i.count}</td>
                                <td><a href="admin/customer/edit/${item.id}">
    ...
    display: inline-block;">
                                ...
                                <td><a href="admin/customer/delete/${item.id}">
