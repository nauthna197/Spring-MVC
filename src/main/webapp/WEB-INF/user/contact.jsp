...
<div class="container">
    <div class="sixteen columns">
        ...
        <div id="pageName">
            <div class="name_tag">
                <p>
                    You're Here :: <a href="#">home</a> :: Contact Us
                </p>
...
<div class="container">
    <div class="sixteen columns">
        ...
        <div class="eleven columns alpha">
            <div id="googleMap">
                <iframe width="100%" height="372px" border="0" scrolling="no" marginheight="0" marginwidth="0"
        ...
        <div class="five columns omega">
            <div class="blocked_info">
                <div>
                    ...
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur eu risus lorem, ut placerat
                        nisl.
                    </p>
                </div>
        ...
        <section id="tagLine" class="clearfix">
            <div class="twelve columns">
                <h5>
                    ...
                    <small>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque non scelerisque
                        lectus
                    </small>
                </h5>
            </div>
